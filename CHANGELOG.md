...
- Admin Platform: isolated Host-gated Admin and Moderator console with staff RBAC, audit logs, and tenant operations over existing OpenClawMU APIs.
- Admin Platform: production hardening for trusted-proxy Host headers, CSRF/CORS, hashed sessions, one-shot bootstrap, and session-store termination.
